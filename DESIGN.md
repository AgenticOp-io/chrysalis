...
- **2026-07-06 — D6348** **Dependency hygiene (maintenance).** pnpm overrides for **protobufjs**, **undici**, **esbuild**, **js-yaml**; **vite** 6.4.3 patch; **firebase-tools** 14.27.x — reduce Dependabot surface on dev tooling chain.
