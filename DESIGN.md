...
- **2026-07-06 — D6344** **Maintenance census promotion (G9160).** Promote **sql/html/scss/c/cpp → CWL** hub-gold trace-replay suites after verify replay green — **185/601** oracle-product (**416** below target). No 601/601 claim; post–Phase 46 maintenance only.
