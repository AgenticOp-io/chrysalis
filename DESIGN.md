...
- **2026-06-03 — D2262** **GCE graduation lock timeouts (G2262).** v90 **`month23-graduation-lock`** gate-only vitest **1200s** (17-way **`Promise.all`**; hit **600s** wall on GCE). v108 **900s**, v110 **1200s**; **`gce-hub-authoring-batch-vitest.sh`** **`--testTimeout=1200000`** ceiling.
