...
- **2026-06-17 — D3157** **Queues 186–195 Phase G Phase C replay (G3157–G3251).** **`runPost186CompositeGate`** through **`runPost195CompositeGate`** replay post-114..123 composites; batches **v186–v195**; hub-completion schema **259–268**. **DESIGN §3** unchanged.
