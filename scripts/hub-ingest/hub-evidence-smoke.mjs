#!/usr/bin/env node
/**
 * Hub evidence smoke on a committed oracle fixture (G184).
 */
...
export const HUB_EVIDENCE_SMOKE_KIND = "chrysalis.hub.evidence-smoke";
export const HUB_EVIDENCE_SMOKE_SCHEMA_VERSION = 1;
 ...
 */
export async function runHubEvidenceSmoke(projectDir = defaultFixture) {
  const root = resolve(projectDir);
  const base = {
    kind: HUB_EVIDENCE_SMOKE_KIND,
    schemaVersion: HUB_EVIDENCE_SMOKE_SCHEMA_VERSION,
