#!/usr/bin/env node
/** IR helper attribute metadata smoke — lift-helper-attr-lib (G2288). */
...
export const HUB_IR_HELPER_LIFTING_ATTR_SCHEMA_VERSION = 1;

const scriptRoot = resolve(dirname(fileURLToPath(import.meta.url)), "..", "..");
const fixture = join(scriptRoot, "fixtures/lift-helper-attr-lib");
...
export function runIrHelperLiftingAttrSmoke() {
  ...
  const r = spawnSync(process.execPath, [cliBin, "ingest", fixture], {
    encoding: "utf8",
