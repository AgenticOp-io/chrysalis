#!/usr/bin/env node
/** Oracle capture for lift-helper-sql-param-inline (B5.5 v6). */
...
try {
  ...
  console.log("[drive-lift-helper-sql-param-inline] exercised /alpha, /beta, /gamma, /epsilon, /delta, /zeta, /iota, /kappa, /lambda, /mu, /nu, /xi, and /omicron");
} finally {
  await handle.stop();
}
