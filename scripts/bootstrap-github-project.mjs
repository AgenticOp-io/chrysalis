...
const MASTER_PROGRAM_DRAFT_ISSUES = [
  ...
  },
  {
    ...
    body:
      ...
      "- https://github.com/AgenticOp-io/wptp-matrix (compatibility matrix, 24 edges; CI via Chrysalis `wptp:*-harness`)\n" +
      "- https://github.com/AgenticOp-io/wptp-ir (IR hub v0; `exportIrToWebIrBundleV0`)\n" +
      "- https://github.com/AgenticOp-io/wptp-emit-nextjs (silver Next.js emitter)\n" +
      "- https://github.com/AgenticOp-io/wptp-emit-hono / wptp-adapter-openapi / wptp-adapter-browser (bronze compose)\n\n" +
  ...
  },
  {
    ...
    body:
      "Repository: https://github.com/AgenticOp-io/wptp-matrix\n\n" +
  ...
  },
  {
    ...
    body:
      "Repository: https://github.com/AgenticOp-io/wptp-ir\n\n" +
