...
export async function runWispCwlStaticExport(opts = {}) {
  ...
  // Export bare page bodies; Firebase stage / chimera gateway apply the full shell
  // (original-css + CWL overlay + client scripts).
  const runtime = createCwlRuntime({
    module,
    resolveSession: resolveWispPreviewSession,
    ...(uiAssets
      ? { uiAssets: { ...uiAssets, wrapHtmlDocuments: false } }
      : {}),
  });
