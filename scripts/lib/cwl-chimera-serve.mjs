...
import { createWispChimeraGateway } from "./cwl-chimera-gateway.mjs";
...
function parseArgs(argv) {
  ...
  let svelteFallback = process.env.WISP_SVELTE_FALLBACK ?? undefined;
  ...
  return { cwlPath, backendUrl, host, port, svelteFallback };
}
