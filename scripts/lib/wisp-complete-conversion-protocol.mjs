 ...
 *
 *   node scripts/lib/wisp-complete-conversion-protocol.mjs
 *   node scripts/lib/wisp-complete-conversion-protocol.mjs --allow-incomplete
 *   node scripts/lib/wisp-complete-conversion-protocol.mjs --max-rounds 20
 *   node scripts/lib/wisp-complete-conversion-protocol.mjs --skip-relift
 */
...
export async function runCompleteConversionProtocol(opts = {}) {
  ...
  if (!complete) {
    residuals = {
      ...
      note: "Incomplete under D6448 — conversion not complete until total===0 without force-settle",
    };
