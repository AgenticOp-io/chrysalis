/** WISP markup hole census — shared by G9500 / G9610 showcase bound gates. */

/**
 * @param {string} cwlText
 */
export function countWispMarkupHoles(cwlText) {
...
/**
 * Bucket hole reasons for honest showcase bound reporting (G9610).
 * @param {Record<string, number>} reasons
 */
export function classifyWispHoleBuckets(reasons) {
  /** @type {Record<string, number>} */
  const buckets = {
    noSourceRoute: 0,
    svelteComponent: 0,
...
/**
 * @param {ReturnType<typeof countWispMarkupHoles>} metrics
 * @param {object} bound
 */
export function evaluateWispShowcaseBound(metrics, bound) {
