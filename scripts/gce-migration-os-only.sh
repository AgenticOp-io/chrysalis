...
node scripts/gce-progress.mjs init \
  intelligence-shorthand-close,is-runtime-close,is-t2-lora-prep-close,migration-os-close,open-web-llm-close,wisp-web-llm-poc-close,open-legacy-wedge,migration-evidence-hub-refresh
