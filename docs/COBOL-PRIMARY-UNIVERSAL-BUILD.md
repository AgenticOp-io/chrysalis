...
- [x] COBOL gnu-honest behavioral **65/65** after Tier B Small complete (**G10076**–**G10078**); further Db2/CICS/VSAM/BMS still paused
...
- [x] **G10078 Tier B Small remainder** — `PORTFLIODN`/`ERRHANDDN`/`CKPRSTPH` COPY-linked (65/65; PORTTEST RANDOM untouched)
- [x] **G10077 Tier A+** — leadership queue hygiene: COBOL primary; secondary-dialect bingo paused unless asked
- [x] **G10079–G10082 structural** — BMS DFHM inventory + MAP/MAPSET crosswalk + COTRT BMS + CICS SEND-MAP/TEXT catalog; AID books still holes
