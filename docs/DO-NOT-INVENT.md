...
**G10085–G10103:** WebIR deepen — emit catalogs + hole attrs through TD/TS QUEUE, SELECT ASSIGN, CALL/ACCEPT/DISPLAY, LINK/XCTL crosswalk, residual INCLUDE dual-resolve, HANDLE CONDITION/AID/ABEND, STRING/OPEN, ORGANIZATION/FD, SQL cursors, JCL PGM/DD crosswalk. Still refuse inventing EXTFMAP/DFHATTR stubs or Db2/IMS/MQ/VSAM/JES runtimes. Operator SDFHCOB path: [`COBOL-IBM-SDFHCOB-DROP.md`](./COBOL-IBM-SDFHCOB-DROP.md) (books **gitignored** — never publish).
