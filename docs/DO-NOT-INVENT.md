...
**G10085–G10101:** WebIR deepen — emit catalogs + hole attrs through TD/TS QUEUE, SELECT ASSIGN, CALL/ACCEPT/DISPLAY, LINK/XCTL crosswalk, residual INCLUDE dual-resolve, HANDLE CONDITION names, STRING/OPEN, JCL PGM crosswalk. Still refuse inventing EXTFMAP/DFHATTR stubs or Db2/IMS/MQ/VSAM/JES runtimes. Operator SDFHCOB path: [`COBOL-IBM-SDFHCOB-DROP.md`](./COBOL-IBM-SDFHCOB-DROP.md) (books **gitignored** — never publish).
