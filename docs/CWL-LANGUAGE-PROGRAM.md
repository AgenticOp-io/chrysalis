...
| **IR helper B9+** | Incremental v1.1 depth | **Active** — through B21 (**G6760–G6880**) |
...
## Language v1.1 — active (G6760–G6880)
...
Regression: `pnpm run hub:cwl-language-maintenance-smoke` (**G6731**, includes **G6760** B9 through **G6880** B21).
