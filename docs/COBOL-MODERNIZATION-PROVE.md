...
- **WebIR deepen (**G10085**–**G10106**):** inventory→hole-attr catalogs **exhausted** (`cobol-inventory-peels-exhausted`); **EXTFMAP** sole open P0. **IBM SDFHCOB:** [`COBOL-IBM-SDFHCOB-DROP.md`](./COBOL-IBM-SDFHCOB-DROP.md).
