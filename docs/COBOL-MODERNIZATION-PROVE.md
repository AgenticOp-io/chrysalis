...
- **BMS structural (**G10079** / **G10080** / **G10081**):** `inventoryBmsSource` (DFHMSD/DFHMDI/DFHMDF + POS/LENGTH/ATTRB); CardDemo + COTRTLI/COTRTUP `.bms` in `_upstream/`; online MAP/MAPSET ↔ BMS label crosswalk with honest holes for `INQMAP`/`INQMNU`/`PORT*`/`PORTSET`. No DFHAID/DFHBMSCA/EXTFMAP invent.
