...
- **WebIR deepen (**G10085**–**G10101**):** emit catalogs; hole-attr control/FILE/QUEUE; **G10100** TD/TS QUEUE, SELECT ASSIGN, CALL/ACCEPT/DISPLAY, LINK/XCTL crosswalk, residual P0=EXTFMAP-only; **G10101** HANDLE CONDITION names, STRING/OPEN, JCL PGM crosswalk. **EXTFMAP** sole open P0. **IBM SDFHCOB:** [`COBOL-IBM-SDFHCOB-DROP.md`](./COBOL-IBM-SDFHCOB-DROP.md).
