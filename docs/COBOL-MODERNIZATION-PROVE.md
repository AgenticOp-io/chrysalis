...
- **WebIR deepen (**G10085**–**G10103**):** emit catalogs; hole-attr control/FILE/QUEUE; **G10100–G10101** TD/TS, SELECT/CALL/LINK, HANDLE CONDITION, STRING/OPEN, JCL PGM; **G10102–G10103** HANDLE AID/ABEND, org/FD, SQL cursors, JCL DD↔ASSIGN. **EXTFMAP** sole open P0. **IBM SDFHCOB:** [`COBOL-IBM-SDFHCOB-DROP.md`](./COBOL-IBM-SDFHCOB-DROP.md).
