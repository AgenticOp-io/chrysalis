...
```bash
tar -tzf release/chrysalis-2.0.1-source.tar.gz | head
mkdir /tmp/chrysalis-unpack && tar -xzf release/chrysalis-2.0.1-source.tar.gz -C /tmp/chrysalis-unpack
cd /tmp/chrysalis-unpack/chrysalis-2.0.1
