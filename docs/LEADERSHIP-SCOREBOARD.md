...
**As of:** 2026-07-29 (G10097 card-* WebIR catalogs; G10093–G10096; CMQ* closed; EXTFMAP sole P0)
...
| COBOL primary | **65/65** behavioral; WebIR deepen **G10085–G10097** (emit→WebIR catalogs through card-* fee/pay/status; licensed AID+CMQ drop local-only) | no LCB claim; **EXTFMAP** sole P0 COPY + Db2/IMS/MQ runtimes still holes — see [`COBOL-IBM-SDFHCOB-DROP.md`](./COBOL-IBM-SDFHCOB-DROP.md) |
...
| **2c** | COBOL→WebIR deepen (CWL-shaped) | **Closed G10085–G10097** — emit literals + typed binOp + catalogs through card-* fee/pay/status + seq-ctl/seq-key + indexed-row + site-inventory + residual ledger |
...
3. Cheap CLBS emit→WebIR catalog wave **exhausted** (G10085–G10097); next deepen needs new origin subjects or chartered runtime
