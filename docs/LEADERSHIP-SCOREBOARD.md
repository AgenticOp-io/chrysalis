...
**As of:** 2026-07-30 (G10099 CICS FILE/QUEUE + BMS crosswalk hole attrs; G10098; EXTFMAP sole P0)
...
| COBOL primary | **65/65** behavioral; WebIR deepen **G10085–G10099** (FILE/QUEUE + BMS crosswalk hole attrs; licensed AID+CMQ drop local-only) | no LCB claim; **EXTFMAP** sole P0 COPY + Db2/IMS/MQ runtimes still holes — see [`COBOL-IBM-SDFHCOB-DROP.md`](./COBOL-IBM-SDFHCOB-DROP.md) |
...
| **2c** | COBOL→WebIR deepen (CWL-shaped) | **Closed G10085–G10099** — emit catalogs + hole attrs through CICS FILE/QUEUE + BMS crosswalk + SQL INCLUDE expand + residual ledger |
...
3. Cheap inventory peels largely closed through G10099; next needs EXTFMAP drop/ABSENT or chartered runtime
