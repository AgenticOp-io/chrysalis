...
**Closed program regression:** `hub:ut-canon-program-close-smoke` (**G9990**) · `hub:ut-maintain-packaging-smoke` (**G9991**) · `hub:ut-wave-a-close-smoke` (**G9965**) · `hub:ut-wave-b-close-smoke` (**G9975**) · `hub:ut-wave-c-close-smoke` (**G9985**) · `hub:ut-wave-d-close-smoke` (**G9989**) · `hub:cwl-universal-translator-close-smoke` (**G7690**) · `hub:migration-os-close-smoke` (**G8550**) · `hub:multi-origin-lift-close-smoke` (**G9880**) · `hub:elixir-smoke` (**G9953**, foundation) · `hub:dart-smoke` (**G9954**, foundation) · `hub:complete-conversion-prove:elixir` (**G9955**, D6448-ST) · `hub:complete-conversion-prove:dart` (**G9956**, D6448-ST) · `hub:restify-smoke` (**G9957**) · `hub:polka-smoke` (**G9958**) · `hub:koa-smoke` / `hub:restify-smoke` / `hub:polka-smoke` v2 (**G9959**, pass-through mw) · `hub:cobol-clbs-prove-smoke` (**G10001**, CardDemo CSUTLDWY/CSSETATY COPY resolve) · `hub:contract-import-cwl-roundtrip-smoke` + `batch-ckprst-copy-resolve` (**G10002**) · OpenAPI/HAR cookie peels (**G10031**) · OpenAPI/HAR response-header peels (**G10054**) · `hub:fastapi-smoke` (**G10003**) · `hub:starlette-smoke` (**G10013**) · `hub:ktor-smoke` (**G10004**) · `hub:http4k-smoke` (**G10024**) · `hub:koa-smoke` / `hub:hapi-smoke` / `hub:restify-smoke` / `hub:polka-smoke` destructure (**G10005**) · `hub:dart-smoke` named handlers (**G10007**) · `hub:aspnet-controllers-smoke` (**G10008**) · `hub:carter-smoke` (**G10041**, Minimal API Map\* peel reuse) · `hub:jaxrs-smoke` (**G10012**) · `hub:micronaut-smoke` (**G10020**) · `hub:quarkus-smoke` (**G10034**, JAX-RS peel reuse) · `hub:javalin-smoke` (**G10035**) · `hub:sparkjava-smoke` (**G10036**) · `hub:jooby-smoke` (**G10046**) · `hub:vertx-smoke` (**G10052**) · `hub:webflux-smoke` (**G10061**) · `hub:helidon-smoke` (**G10042**, JAX-RS peel reuse) · `hub:chi-smoke` (**G10009**) · `hub:echo-smoke` (**G10010**) · `hub:fiber-smoke` (**G10017**) · `hub:iris-smoke` (**G10038**) · `hub:beego-smoke` (**G10045**) · `hub:buffalo-smoke` (**G10055**) · `hub:martini-smoke` (**G10056**) · `hub:gorilla-smoke` (**G10018**) · `hub:servemux-smoke` (**G10030**) · `hub:hummingbird-smoke` (**G10016**) · `hub:hono-smoke` (**G10019**) · `hub:hono-smoke` v2 (**G10044**, pass-through mw) · `hub:elysia-smoke` (**G10025**) · `hub:elysia-smoke` v2 (**G10053**, empty lifecycle) · `hub:oak-smoke` (**G10043**) · `hub:itty-smoke` (**G10047**) · `hub:adonis-smoke` (**G10059**) · `hub:bun-serve-smoke` (**G10048**) · `hub:cf-workers-smoke` (**G10063**) · `hub:litestar-smoke` (**G10021**) · `hub:falcon-smoke` (**G10023**) · `hub:quart-smoke` (**G10026**) · `hub:bottle-smoke` (**G10027**) · `hub:slim-smoke` (**G10028**) · `hub:lumen-smoke` (**G10049**) · `hub:sanic-smoke` (**G10033**) · `hub:aiohttp-smoke` (**G10039**) · `hub:poem-smoke` (**G10029**) · `hub:salvo-smoke` (**G10037**)

**Amended 2026-07-27 (D6521 / G10059) — AdonisJS TypeScript ORIGIN secondary dialect.** `hub-gold-adonis` + `hub:adonis-smoke` (20/20). Peels `Route.get|post|…` / `router.get` in `start/routes.ts`, `:id` via `request.param`, `request.qs().q`, `response.json` / `response.status(N).json`. Express/TS remain D6448-ST. Lucid / IoC / controller string refs = honest holes (no invent). Catalog: [`js-secondary-dialect-honest-holes.json`](../fixtures/ci/js-secondary-dialect-honest-holes.json).

**Amended 2026-07-27 (D6525 / G10063) — Cloudflare Workers fetch-export JS/TS ORIGIN secondary dialect.** `hub-gold-cf-workers` + `hub:cf-workers-smoke` (20/20). Peels `export default { async fetch(request, env, ctx) { … } }` with `` switch (`${request.method} ${url.pathname}`) `` / method+pathname `if`, `Response.json` / `{ status: N }`, `url.searchParams.get`. Express/TS remain D6448-ST; **itty-router** remains Workers router dialect (D6509); Bun.serve stays green. KV/D1/`env` / dynamic segments / opaque fetch = honest holes. Catalog: [`js-secondary-dialect-honest-holes.json`](../fixtures/ci/js-secondary-dialect-honest-holes.json).

**Amended 2026-07-27 (D6524 / G10062) — Padrino Ruby secondary dialect.** `hub-gold-padrino` + `hub:padrino-smoke` (20/20). Peels `Padrino.configure_apps` + `class HubApp < Padrino::Application` + flat Sinatra-compatible `get|post|… "/path"`, `/:id`, Hash/`status`/`params[]` — **reuses Sinatra peels** (same cheap path as Grape G10032). Sinatra remains Ruby D6448-ST; Roda/Grape stay green. Symbol controllers/`Padrino.mount`/filters = honest holes. Catalog: `fixtures/ci/padrino-honest-holes.json`. Rails stays skipped (G10006).

**Amended 2026-07-27 (D6510 / G10048) — Bun.serve TypeScript ORIGIN secondary dialect.** `hub-gold-bun-serve` + `hub:bun-serve-smoke` (20/20). Peels `Bun.serve({ routes: { "/path": { GET|POST|…: handler } } })`, `:id` paths, `req.params`, `new URL(req.url).searchParams.get`, `Response.json` / `Response.json(body, { status: N })`. Express/TS remain D6448-ST. `fetch` fallback / websocket / plugins / static Response = honest holes. Catalog: [`js-secondary-dialect-honest-holes.json`](../fixtures/ci/js-secondary-dialect-honest-holes.json).

**Amended 2026-07-27 (D6522 / G10060) — Deno.serve TypeScript ORIGIN secondary skipped.** `Deno.serve(handler)` has **no** Bun-like `{ routes }` object; origin routing is pathname+method switch / `URLPattern` / `@std/http` `route` — control-flow peels, not Bun routes-object reuse (D6510 already holes switch-only servers). Probe: `astRouteCount` 0. Honest skip: [`fixtures/ci/deno-serve-honest-skip.json`](../fixtures/ci/deno-serve-honest-skip.json). Oak / Bun.serve / itty remain green. Catalog: `fixtures/ci/js-secondary-dialect-honest-holes.json`.

**Amended 2026-07-24 (D6499 / G10037) — Salvo Rust secondary dialect.** `hub-gold-salvo` + `hub:salvo-smoke` (20/20). Peels `Router::with_path("…").get|post|…(handler)` / `.path` + flat `.push`, `{id}` paths, `req.param`/`req.query`, `Json(serde_json::json!)` + `res.status_code(StatusCode::*)`. Actix remains Rust D6448-ST; Axum/Rocket/Poem stay green. Nested push path-join / hoop / OpenAPI = honest holes. Catalog: `fixtures/ci/salvo-honest-holes.json`.

**Amended 2026-07-24 (D6501 / G10039) — aiohttp Python secondary dialect.** `hub-gold-aiohttp` + `hub:aiohttp-smoke` (20/20). Peels `web.Application()`, `web.get|post|…('/path', handler)`, `{id}` / `{id:\d+}` paths, `request.match_info`, `request.query.get`, `web.json_response` / `web.Response` (additive `parse_routes.py` peels). Flask remains Python D6448-ST. Middleware/subapp/`web.View`/WebSocket = honest holes. Catalog: `fixtures/ci/aiohttp-honest-holes.json`.

**Amended 2026-07-27 (G10050) — Nancy FX C# secondary skipped.** NancyModule constructor `Get|Post|…` + `Response.AsJson` / `HttpStatusCode` / dynamic `parameters.id` is **not** Minimal API Map* peel-reuse (unlike Carter D6503). Probe: 0 routes on current `parseCsharpRoutes`. Honest skip: [`fixtures/ci/nancy-honest-skip.json`](../fixtures/ci/nancy-honest-skip.json). No D6512. Carter + ASP.NET controllers remain green. Catalog: `fixtures/ci/csharp-secondary-dialect-honest-holes.json`.

**Amended 2026-07-27 (G10057) — Tapir Scala secondary skipped.** Fluent `endpoint.get.in("path").out(jsonBody|plainBody|…)` (+ optional Http4s/Akka server interpreters / `serverLogicSuccess`) is **not** Finch string-led `get("path") { Ok(…) }` or Http4s `case → Ok` peel-reuse (G10051 / Http4s secondary). Probe: 0 routes on current `parseScalaRoutes`. Codec `.out` invent forbidden (**D6447**); path+method-only is not 20/20 hole-free. Honest skip: [`fixtures/ci/tapir-honest-skip.json`](../fixtures/ci/tapir-honest-skip.json). No D6519. Akka remains Scala D6448-ST; Http4s + Finch remain green.

**Amended 2026-07-24 (D6503 / G10041) — Carter C# secondary dialect.** `hub-gold-carter` + `hub:carter-smoke` (20/20). Peels `ICarterModule` + `AddRoutes(IEndpointRouteBuilder app)` + `app.MapGet|MapPost|…` — **reuses Minimal API Map\* peels** (no MapCarter/DI invent). Minimal API remains C# D6448-ST; ASP.NET controllers remain first C# secondary. Catalog: `fixtures/ci/csharp-secondary-dialect-honest-holes.json`.


**Amended 2026-07-24 (D6506 / G10044) — Hono empty/next-only pass-through middleware.** Parallel to G9959: peel Hono ORIGIN `app.use` empty/`await next()`/`return next()` as `js.passthrough` (shared `hub-express-middleware.mjs`; no onion invent). `hub:hono-smoke` schema v2 (20 + 2 mw). Complex Hono middleware stays honest holes. Catalog: [`js-secondary-dialect-honest-holes.json`](../fixtures/ci/js-secondary-dialect-honest-holes.json). **≠ emit-hono.**
**Amended 2026-07-27 (D6515 / G10053) — Elysia empty lifecycle pass-through.** Parallel to G10044/G9959: peel empty ORIGIN `app.onRequest(() => {})` / `app.onBeforeHandle(() => {})` as `js.passthrough`. Elysia plugin `.use` is **not** `(ctx, next)` — honest hole (no invent). `hub:elysia-smoke` schema v2 (20 + 2 mw). Catalog: [`js-secondary-dialect-honest-holes.json`](../fixtures/ci/js-secondary-dialect-honest-holes.json).

**Amended 2026-07-27 (D6517 / G10055) — Go Buffalo secondary dialect.** `hub-gold-buffalo` + `hub:buffalo-smoke` (20/20). Peels `app.GET|POST|…`, `{id}`/`:id` paths, `c.Param`, `c.Render`/`r.JSON`/`r.String`. Gin remains Go D6448-ST. Middleware/Group/Resource/binders/HTML/non-literal paths = honest holes. Catalog: `fixtures/ci/go-secondary-dialect-honest-holes.json`.

**Amended 2026-07-27 (D6518 / G10056) — Go Martini secondary dialect.** `hub-gold-martini` + `hub:martini-smoke` (20/20). Peels `martini.Classic()`, `m.Get|Post|…`, `:id` paths, `params["id"]` (`martini.Params`), `req.URL.Query().Get`, `r.JSON` / `json.NewEncoder(w)` / `io.WriteString` / string returns. Gin remains Go D6448-ST. Use/Group/Map/binding/non-literal paths = honest holes. Catalog: `fixtures/ci/go-secondary-dialect-honest-holes.json`.

**Amended 2026-07-27 (D6507 / G10045) — Go Beego v2 functional secondary dialect.** `hub-gold-beego` + `hub:beego-smoke` (20/20). Peels `web.Get|Post|…`, `:id` paths, `ctx.Input.Param(":id")`, `ctx.Input.Query`, `ctx.JSONResp` / `ctx.Output.SetStatus` / `ctx.WriteString`. Gin remains Go D6448-ST. Filter/NS/Controller/binders/non-literal paths = honest holes. Catalog: `fixtures/ci/go-secondary-dialect-honest-holes.json`.




**Amended 2026-07-27 (D6511 / G10049) — Lumen / Laravel-router PHP secondary dialect.** `hub-gold-lumen` + `hub:lumen-smoke` (20/20). Peels `$router->get|post|…` / `Route::get|post` closures, `{id}` path args, `$request->query|input`, `response()->json` (+ status) — additive `php-ast-ingest.mjs` (Slim G10028 unchanged; packages/ingest Laravel/Symfony/plain unchanged). Laravel min / Symfony / plain-php remain PHP D6448-ST. Middleware/`$router->group`/cross-file controllers = honest holes. Catalog: `fixtures/ci/lumen-honest-holes.json`.
**Amended 2026-07-24 (D6490 / G10028) — Slim PHP secondary dialect.** `hub-gold-slim` + `hub:slim-smoke` (20/20). Peels `$app->get|post|…`, `{id}` paths, `$args['…']`, `$request->getQueryParams()`, `$response->withJson` / `withStatus` / write+json_encode (`php-ast-ingest.mjs`; packages/ingest Laravel/Symfony/plain unchanged). Laravel min / Symfony / plain-php remain PHP D6448-ST. PSR-15/`$app->group`/named handlers = honest holes. Catalog: `fixtures/ci/slim-honest-holes.json`.

**Amended 2026-07-24 (D6495 / G10033) — Sanic Python secondary dialect.** `hub-gold-sanic` + `hub:sanic-smoke` (20/20). Peels `@app.get|post|…` / `@app.route`, `<id>` / `<id:str>` paths, `request.args.get`, `json()` / `text()` (+ `status=`) — additive `parse_routes.py` peels. Flask remains Python D6448-ST. Middleware/Blueprint/listeners/WebSocket = honest holes. Catalog: `fixtures/ci/sanic-honest-holes.json`.

**Amended 2026-07-24 (D6500 / G10038) — Go Iris secondary dialect.** `hub-gold-iris` + `hub:iris-smoke` (20/20). Peels `iris.New()`, `app.Get|Post|…`, `{id}`/`:id` paths, `ctx.Params().Get`, `ctx.URLParam`/`URLParamDefault`, `ctx.JSON`/`ctx.StatusCode`/`ctx.WriteString`. Gin remains Go D6448-ST. Middleware/Party/binders/non-literal paths = honest holes. Catalog: `fixtures/ci/go-secondary-dialect-honest-holes.json`.

**Amended 2026-07-24 (D6492 / G10030) — Go net/http ServeMux (Go 1.22+) secondary dialect.** `hub-gold-servemux` + `hub:servemux-smoke` (20/20). Peels `http.NewServeMux()`, `HandleFunc("METHOD /path")`, `{id}` paths, `r.PathValue`, `r.URL.Query().Get`, `json.NewEncoder(w).Encode`, `w.WriteHeader(http.Status*)`. Gin remains Go D6448-ST. Middleware wrappers (stdlib none) / pattern conflicts / non-literal paths = honest holes. Catalog: `fixtures/ci/go-secondary-dialect-honest-holes.json`.

**Amended 2026-07-24 (D6491 / G10029) — Poem Rust secondary dialect.** `hub-gold-poem` + `hub:poem-smoke` (20/20). Peels `Route::new().at("/path", get|post|…(handler))`, `.nest("/prefix", named_fn())`, `:id` paths, `Path`/`Query`, `Json(serde_json::json!)`, `(StatusCode::*, Json(…))`. Actix remains Rust D6448-ST; Axum/Rocket stay green. Middleware/poem-openapi/chained multi-method `.at` = honest holes. Catalog: `fixtures/ci/poem-honest-holes.json`.

**Amended 2026-07-24 (D6497 / G10035) — Javalin Java secondary dialect.** `hub-gold-javalin` + `hub:javalin-smoke` (20/20). Peels `Javalin.create()`, `app.get|post|put|patch|delete("/path", ctx -> …)`, `{id}` paths, `ctx.pathParam`/`ctx.queryParam`, `ctx.status(n).json`/`ctx.json`/`ctx.result`. Spring remains Java D6448-ST. Plugins/`before`/`after`/DI/WebSocket = honest holes. Catalog: `fixtures/ci/java-secondary-dialect-honest-holes.json`.

**Amended 2026-07-27 (D6523 / G10061) — Spring WebFlux RouterFunctions Java secondary dialect.** `hub-gold-webflux` + `hub:webflux-smoke` (20/20). Peels `route(GET|POST|…("/path"), req -> …)` / `.andRoute`, `{id}` + `pathVariable`/`queryParam`, `ServerResponse.ok|status().bodyValue`. Spring MVC `@RestController` remains Java D6448-ST; JAX-RS/Javalin/Jooby/Vert.x peers stay green. WebClient/route-builder/path-nest/filters = honest holes. Catalog: `fixtures/ci/java-secondary-dialect-honest-holes.json`.

**Amended 2026-07-27 (D6508 / G10046) — Jooby Java secondary dialect.** `hub-gold-jooby` + `hub:jooby-smoke` (20/20). Peels `new Jooby() {{ get|post|… }}` / `app.get|post|…`, `{id}` paths, `ctx.path`/`ctx.query`, `ctx.setResponseCode`, Map.of + scalar returns. Spring remains Java D6448-ST; Javalin/Spark/JAX-RS peers stay green. Module/MVC/filters/WebSocket = honest holes. Catalog: `fixtures/ci/java-secondary-dialect-honest-holes.json`.

**Amended 2026-07-24 (D6504 / G10042) — Helidon MP JAX-RS Java secondary dialect.** `hub-gold-helidon` + `hub:helidon-smoke` (20/20). Helidon MP HTTP uses standard JAX-RS (`jakarta.ws.rs.*`); **reuses G10012 peels** via `runJaxrsSmoke` — no Helidon CDI/MP Config/SE invent. Spring remains Java D6448-ST. Catalog: `fixtures/ci/java-secondary-dialect-honest-holes.json`.

**Amended 2026-07-24 (D6496 / G10034) — Quarkus JAX-RS Java secondary dialect.** `hub-gold-quarkus` + `hub:quarkus-smoke` (20/20). Quarkus HTTP uses standard JAX-RS (`jakarta.ws.rs.*`); **reuses G10012 peels** via `runJaxrsSmoke` — no Quarkus CDI/RESTEasy/Panache invent. Spring remains Java D6448-ST. Catalog: `fixtures/ci/java-secondary-dialect-honest-holes.json`.

**Amended 2026-07-24 (D6489 / G10027) — Bottle Python secondary dialect.** `hub-gold-bottle` + `hub:bottle-smoke` (20/20). Peels bare `@get|post|…` / `@route(..., method=)`, `<id>` paths, `request.query.q` / `request.params`, dict/string / `HTTPResponse(body, status=N)` (additive `parse_routes.py` peels). Flask remains Python D6448-ST. Plugins/middleware/templates/mount = honest holes. Catalog: `fixtures/ci/bottle-honest-holes.json`.

**Amended 2026-07-27 (D6516 / G10054) — OpenAPI/HAR response-header peel deepen.** OpenAPI IDENT-safe response `headers` → CWL `response-header` when example/schema.default present; HAR IDENT-safe `response.headers` (skip hop-by-hop / `content-type`; never invent when absent). Gold `hub-gold-openapi-cwl` / `hub-gold-har-cwl`; Vitest G10054; smoke `hub:contract-import-cwl-roundtrip-smoke`. `/raw` stays hole.

**Amended 2026-07-24 (D6493 / G10031) — OpenAPI/HAR cookie request-surface deepen.** OpenAPI IDENT-safe `in: cookie` → CWL `cookie`; HAR IDENT-safe `cookies[]` → CWL `cookie` when present (never invent when absent). Gold `hub-gold-openapi-cwl` / `hub-gold-har-cwl`; Vitest G10031; smoke `hub:contract-import-cwl-roundtrip-smoke`. `/raw` and BMS stay honest holes.

**Amended 2026-07-24 (D6488 / G10026) — Quart Python secondary dialect.** `hub-gold-quart` + `hub:quart-smoke` (20/20). Peels Flask-async twin `@app.get|post|…` / `@app.route`, `<id>` paths, `request.args`, status tuples (reuses Flask peels in `parse_routes.py`). Flask remains Python D6448-ST. Middleware/WebSocket/Blueprint beyond cheap = honest holes. Catalog: `fixtures/ci/quart-honest-holes.json`.

**Amended 2026-07-24 (D6479 / G10017) — Go Fiber secondary dialect.** `hub-gold-fiber` + `hub:fiber-smoke` (20/20). Peels `app.Get|Post|…`, `:id` paths, `c.Params`, `c.Query`, `c.JSON` / `c.Status(n).JSON` / `c.SendString`. Gin remains Go D6448-ST. Middleware/Group/`BodyParser`/non-literal paths = honest holes. Catalog: `fixtures/ci/go-secondary-dialect-honest-holes.json`.

**Amended 2026-07-24 (D6480 / G10018) — Go Gorilla mux secondary dialect.** `hub-gold-gorilla` + `hub:gorilla-smoke` (20/20). Peels `HandleFunc`+`Methods`, `{id}` paths, `mux.Vars`, `r.URL.Query().Get`, `json.NewEncoder(w).Encode`, `w.WriteHeader(http.Status*)`. Gin remains Go D6448-ST. Middleware/Subrouter/non-literal paths = honest holes. Catalog: `fixtures/ci/go-secondary-dialect-honest-holes.json`.

**Amended 2026-07-24 (D6482 / G10020) — Micronaut Java secondary dialect.** `hub-gold-micronaut` + `hub:micronaut-smoke` (20/20). Peels `@Controller` prefix join + `@Get|Post|…` + `@PathVariable`/`@QueryValue`(+`defaultValue`) + `Map.of` + `HttpResponse.status().body()`. Spring remains Java D6448-ST. DI/filters/`Application.run` = honest holes. Catalog: `fixtures/ci/java-secondary-dialect-honest-holes.json`.
...
**Amended 2026-07-24 (D6486 / G10024) — http4k Kotlin secondary dialect.** `hub-gold-http4k` + `hub:http4k-smoke` (20/20). Peels `"path" bind Method.GET|POST|… to`, `{id}` paths, `req.path` / `req.query`, `Response(OK|CREATED|ACCEPTED).body`. Spring remains Kotlin D6448-ST; Ktor remains first Kotlin secondary. Filters/lenses/nested routes/server backends = honest holes. Catalog: `fixtures/ci/http4k-honest-holes.json`.

**Amended 2026-07-27 (D6509 / G10047) — itty-router JS/TS ORIGIN secondary dialect.** `hub-gold-itty` + `hub:itty-smoke` (20/20). Peels `Router()`, `router.get|post|…`, `:id` via `request.params`, query from URL `searchParams`, `json()` / `Response.json` / `new Response` (+ ResponseInit status). Express/TS remain D6448-ST. Empty `router.all` closed via G10064 / D6526; complex middleware/nested Router = honest holes. Catalog: `fixtures/ci/js-secondary-dialect-honest-holes.json`.

**Amended 2026-07-27 (D6526 / G10064) — itty-router empty/next-only pass-through middleware peel.** Parallel to Hono (D6506 / G10044) and Elysia empty lifecycle (D6515 / G10053): itty has **no** Express-style `next()` — continue by omitting return. Peel empty/`next`-only `router.all(pathLit, fn)` as `js.passthrough`. Gold `hub-gold-itty` +2 empty `router.all('*', () => {})`; `hub:itty-smoke` schema v2 (20 routes + 2 mw presets). Complex `all` / multi-handler / nested Router stay honest holes.

**Amended 2026-07-24 (D6505 / G10043) — Oak Deno/JS ORIGIN secondary dialect.** `hub-gold-oak` + `hub:oak-smoke` (20/20). Peels `new Application()`, `router.get|post|…`, `:id` / `{id}` (brace → `:id`), `ctx.params`, `ctx.request.url.searchParams.get`, `ctx.response.body` / `ctx.response.status`. Express/TS remain D6448-ST. Middleware/`router.routes()` = honest holes. Catalog: `fixtures/ci/js-secondary-dialect-honest-holes.json`.

**Amended 2026-07-24 (D6487 / G10025) — Elysia TypeScript ORIGIN secondary dialect.** `hub-gold-elysia` + `hub:elysia-smoke` (20/20). Peels `new Elysia()`, `app.get|post|…`, `ctx.params`/`ctx.query`, IDENT-safe `({ params: { id } })` / `({ query: { q } })` bags (G10005 reuse), `ctx.set.status`, literal/object returns. Express/TS remain D6448-ST. Plugins/lifecycle/macros = honest holes. Catalog: `fixtures/ci/js-secondary-dialect-honest-holes.json`.

**Amended 2026-07-24 (D6481 / G10019) — Hono TypeScript ORIGIN secondary dialect.** `hub-gold-hono` + `hub:hono-smoke` (20/20). Peels `new Hono()`, `app.get|post|…`, `c.req.param`/`c.req.query`, `c.json`/`c.text` (+ numeric status). Express/TS remain D6448-ST. **≠ emit-hono** outbound. Middleware/`app.use` = honest holes. Catalog: `fixtures/ci/js-secondary-dialect-honest-holes.json`.

**Amended 2026-07-24 (D6483 / G10021) — Litestar secondary dialect.** `hub-gold-litestar` + `hub:litestar-smoke` (20/20). Peels bare `@get|post|…`, `{id}` paths, `request.query_params`, decorator `status_code=` (reuses FastAPI/Starlette peels). Flask remains Python D6448-ST. Provide/DI/middleware/Controller/`Response` wrappers/WebSocket = honest holes.

**Amended 2026-07-24 (D6485 / G10023) — Falcon Python secondary dialect.** `hub-gold-falcon` + `hub:falcon-smoke` (20/20). Peels same-file `app.add_route` + class `on_get|on_post|…`, `{id}` paths, `req.get_param`, `resp.media`/`resp.text`/`resp.status`. Flask remains Python D6448-ST. Hooks/middleware/ASGI onion = honest holes.
