...
4. **Extended matrix census** — `hub:extended-matrix-oracle-progress-smoke` (**G9160**) — **401** pairs below oracle-product (baseline **200/601**); wave **8** maintenance **`hub:extended-matrix-oracle-wave8-smoke`** (**G9161**)
