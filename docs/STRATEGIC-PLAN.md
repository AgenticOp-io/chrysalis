...
4. **Extended matrix census** — `hub:extended-matrix-oracle-progress-smoke` (**G9160**) — **376** pairs below oracle-product (baseline **225/601**); wave **8** **`hub:extended-matrix-oracle-wave8-smoke`** (**G9161**); wave **9** **`hub:extended-matrix-oracle-wave9-smoke`** (**G9163**)
