...
| **42a.2** | Hole proposals logged to trajectory; verify before apply | **G8812** (`hub:llm-convert-hole-proposals-smoke`) |
| **42a.3** | Hub UI: show IS tier + skipLlm on job progress | **G8813** (`hub:llm-convert-ui-routing-smoke`) |
