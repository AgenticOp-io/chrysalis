...
- **Compatibility matrix (D5):** [theorem6/wptp-matrix](https://github.com/theorem6/wptp-matrix) (`@wptp/matrix@v0.1.8`) — **20 edges**, compose + `verify:harness`, [GitHub Pages](https://theorem6.github.io/wptp-matrix/)
...
| wptp-matrix                       | v0.1.8                   | `npm ci` from `github:theorem6/*` tags; CI + Pages green |
...
| --- | --- | --- | --- |
| 1 | D5 matrix product | **Done** | 20 edges, 10 composer paths, Pages, [`MASTER-PROGRAM.md`](./MASTER-PROGRAM.md) D5 exit met |
