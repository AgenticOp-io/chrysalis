...
| Language pin | `file:../chrysalis-cwl/packages/cwl` ≡ **`1.0.17`** (`hub:cwl-pin-smoke`) |
...
**Registry:** `@agenticop-io/cwl@1.0.17` via [`.npmrc.example`](../.npmrc.example) (do not commit tokens).
