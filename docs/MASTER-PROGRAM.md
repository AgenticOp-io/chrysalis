...
| **[`theorem6/wptp-matrix`](https://github.com/theorem6/wptp-matrix)** | Public **compatibility matrix** JSON + validator (no false Gold) | **D5 in progress** — **18** edges, Pages, `verify:harness` (**2026-05-19**) |
