...
| **B5.5** | Ingest inlining of lib helpers whose body is **`return <effect.db.query>`** (zero-arg, parametric, or assign-then-return). | **Done (v1–v4)** — **`tryInlineLibHelperCall`** + **`HelperBodyEntry`**; **v2:** emit replay for sql-same-twin; **v3:** parametric + local-assign bodies + sql-case-twin replay + fixture **`lift-helper-sql-param-inline`**; **v4:** emit replay for sql-param-inline. |
