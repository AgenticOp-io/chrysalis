...
/**
 * hub-gold-helidon — 20-route Helidon MP JAX-RS resource dialect (secondary to Spring hub-flagship-java ST).
 * Helidon MP HTTP uses standard JAX-RS (@Path / @GET / @PathParam / Response) with jakarta.ws.rs.*.
 * Route surface only — reuses G10012 JAX-RS peels; no CDI / MP Config / Helidon SE invent (D6447).
 */
@Path("")
public class HubResource {
  ...
  public Map<String, Object> meta() {
    return Map.of("service", "hub-gold-helidon", "version", 1);
  }
