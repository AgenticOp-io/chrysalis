...
handler wisp_api_plans_get {
  # source backend-services/routes/plans
  effects: db, session;
  use auth bearer;
...
handler wisp_api_network_get {
  # source backend-services/routes/network
  effects: db, session;
  use auth bearer;
...
handler wisp_api_customers_get {
  # source backend-services/routes/customers
  effects: db, session;
  use auth bearer;
...
handler wisp_api_customer_billing_get {
  # source backend-services/routes/customer-billing
  effects: db, session;
  use auth bearer;
...
handler wisp_api_inventory_get {
  # source backend-services/routes/inventory
  effects: db, session;
  use auth bearer;
...
handler wisp_api_bundles_get {
  # source backend-services/routes/bundles
  effects: db, session;
  use auth bearer;
...
handler wisp_api_deploy_get {
  # source backend-services/routes/deploy
  effects: db, session;
  use auth bearer;
...
handler wisp_api_hss_get {
  # source backend-services/routes/hss
  effects: db, session;
  use auth bearer;
...
handler wisp_api_monitoring_get {
  # source backend-services/routes/monitoring
  effects: db, session;
  use auth bearer;
...
handler wisp_api_maintain_get {
  # source backend-services/routes/maintain
  effects: db, session;
  use auth bearer;
...
handler wisp_api_users_get {
  # source backend-services/routes/users
  effects: db, session;
  use auth bearer;
...
handler wisp_api_work_orders_get {
  # source backend-services/routes/work-orders
  effects: db, session;
  use auth bearer;
...
handler wisp_api_permissions_get {
  # source backend-services/routes/permissions
  effects: db, session;
  use auth bearer;
...
handler wisp_api_mikrotik_get {
  # source backend-services/routes/mikrotik
  effects: db, session;
  use auth bearer;
...
handler wisp_api_epc_updates_get {
  # source backend-services/routes/epc-updates
  effects: db, session;
  use auth bearer;
...
handler wisp_api_snmp_monitoring_get {
  # source backend-services/routes/snmp-monitoring
  effects: db, session;
  use auth bearer;
...
handler wisp_api_monitoring_graphs_get {
  # source backend-services/routes/monitoring-graphs
  effects: db, session;
  use auth bearer;
...
handler wisp_api_device_assignment_get {
  # source backend-services/routes/device-assignment
  effects: db, session;
  use auth bearer;
...
handler wisp_api_notifications_get {
  # source backend-services/routes/notifications
  effects: db, session;
  use auth bearer;
...
handler wisp_api_voice_get {
  # source backend-services/routes/voice
  effects: db, session;
  use auth bearer;
...
handler wisp_api_admin_prefix_get {
  # source backend-services/routes/admin-prefix
  effects: db, session;
  use auth bearer;
...
handler wisp_api_internal_get {
  # source backend-services/routes/internal
  effects: db, session;
  use auth bearer;
