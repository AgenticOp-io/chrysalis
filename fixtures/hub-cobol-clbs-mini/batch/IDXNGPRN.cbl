      *> GnuCOBOL INDEXED START KEY NOT GREATER + READ PREVIOUS (BDB) — GCE.
      *> Proves BDB START NOT GREATER THAN + backward PREV sum; still ≠ VSAM.
      *> Distinct from IDXNGTRN (NOT GREATER+NEXT → 70.00), IDXNLPRN
      *> (NOT LESS+PREV → 45.50), IDXLTPRN (LESS+PREV → 20.50).
      *> START NOT GREATER 55 → PREV keys 55+42+20+10 → 75.50.
       IDENTIFICATION DIVISION.
       PROGRAM-ID. IDXNGPRN.
       ENVIRONMENT DIVISION.
       INPUT-OUTPUT SECTION.
       FILE-CONTROL.
           SELECT IDX-FILE ASSIGN TO "idxngprn.dat"
       ...
       01  WS-START-KEY          PIC 9(4) VALUE 55.
