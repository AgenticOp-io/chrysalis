      *> GnuCOBOL INDEXED START KEY LESS THAN + READ NEXT (BDB) — GCE.
      *> Proves BDB START LESS THAN + forward NEXT sum; still ≠ VSAM.
      *> Distinct from IDXLTPRN (LESS+PREV → 20.50), IDXNLNRN (NOT LESS+NEXT
      *> → 78.00), IDXGTNRN (GREATER+NEXT → 45.00).
      *> START LESS 20 → positions at 10; NEXT keys 10+20+42+55+99 → 90.50.
       IDENTIFICATION DIVISION.
       PROGRAM-ID. IDXLTNRN.
       ENVIRONMENT DIVISION.
       INPUT-OUTPUT SECTION.
       FILE-CONTROL.
           SELECT IDX-FILE ASSIGN TO "idxltnrn.dat"
