      *> GnuCOBOL INDEXED START KEY NOT LESS + READ PREVIOUS (BDB) — GCE cobc.
      *> Proves BDB START NOT LESS THAN + backward PREV sum; still ≠ VSAM.
      *> Distinct from IDXGTNRN (START > + READ NEXT) and IDXRNGRN (LINE SEQ >=).
      *> START NOT LESS 42 → PREV includes 42+20+10 → 25.00+8.00+12.50 = 45.50.
       IDENTIFICATION DIVISION.
       PROGRAM-ID. IDXNLPRN.
       ENVIRONMENT DIVISION.
       INPUT-OUTPUT SECTION.
       FILE-CONTROL.
           SELECT IDX-FILE ASSIGN TO "idxnlprn.dat"
