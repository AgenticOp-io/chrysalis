      *> GnuCOBOL INDEXED START KEY > + READ NEXT range (BDB) — GCE cobc.
      *> Proves BDB START GREATER THAN + sequential NEXT sum; still ≠ VSAM.
      *> LINE SEQUENTIAL >= substitute remains IDXRNGRN. Full inventory: IDXVSAM.
      *> Keys > 42 → 30.00 + 15.00 = 45.00 (excludes key 42 unlike IDXRNGRN).
       IDENTIFICATION DIVISION.
       PROGRAM-ID. IDXGTNRN.
       ENVIRONMENT DIVISION.
       INPUT-OUTPUT SECTION.
       FILE-CONTROL.
           SELECT IDX-FILE ASSIGN TO "idxgtnrn.dat"
