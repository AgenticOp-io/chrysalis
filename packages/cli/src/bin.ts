  ...
  if (!root) {
    console.error(
      "usage: chrysalis insight <php-project-dir>\n" +
        ...
        "                         [--ingest-dedupe-structural-subgraphs] [--ingest-dedupe-structural-subgraphs-ignore-origin] [--ingest-lift-shared-helpers]\n" +
