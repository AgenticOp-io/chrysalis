    ...
    try {
      writeFileSync(
        ...
        `${JSON.stringify({
          ...
          ok: true,
          matrixSmoke: { passed: 22, failed: 0, skipped: 0 },
          goldVerify: { ok: true, suiteCount: 66, expectedSuiteCount: 66, suiteIds: [] },
          traceReplay: {
            ok: true,
            correctness: 1,
            suiteCount: 38,
            expectedSuiteCount: 38,
            suiteIds: [],
            targets: ["hono", "fastify", "nextjs"],
          },
          nextjsTraceReplay: {
            suites: ["js-literal-nextjs", "ts-literal-nextjs", "js-structured-nextjs", "ts-structured-nextjs"],
          },
          nativeEmitSmoke: { ok: true, passed: 10, failed: 0 },
