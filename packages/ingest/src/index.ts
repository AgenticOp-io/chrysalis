...
export {
  ...
  findMatchingPascalClose,
  extractNamedSlotBodies,
  foldNamedSlotsIntoHtml,
  ...
  promoteSvelteHolesToRuntimeBindings,
  scrubStructuralMarkupArtifacts,
  rewriteSvelteDynamicAttributes,
  rewriteSvelteEventAttributes,
  stampClosedUiChrome,
