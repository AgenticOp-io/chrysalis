...
function emitKnownCall(ctx: EmitCtx, callee: string, args: string[]): string {
  ...
  switch (callee) {
    ...
    case "strrpos":
      return `String(${args[0]}).lastIndexOf(${args[1]})`;
    case "strripos":
    ...
    case "strncasecmp":
      return `((a,b,n)=>{a=String(a).toLowerCase().slice(0,n);b=String(b).toLowerCase().slice(0,n);return a===b?0:a<b?-1:1})(${args[0]},${args[1]},${args[2]})`;
    case "strrev":
