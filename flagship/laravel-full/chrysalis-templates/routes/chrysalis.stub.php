...
Route::get("/chrysalis-between-one-two-count", function () {
    $body = require base_path("chrysalis/handlers/between_one_two_count_show.php");
    return response((string) $body, 200, ["Content-Type" => "application/json; charset=utf-8"]);
});

Route::get("/chrysalis-gt-three-count", function () {
    $body = require base_path("chrysalis/handlers/gt_three_count_show.php");
    return response((string) $body, 200, ["Content-Type" => "application/json; charset=utf-8"]);
});

Route::get("/chrysalis-lt-one-count", function () {
    $body = require base_path("chrysalis/handlers/lt_one_count_show.php");
    return response((string) $body, 200, ["Content-Type" => "application/json; charset=utf-8"]);
});

Route::get("/chrysalis-gte-three-count", function () {
    $body = require base_path("chrysalis/handlers/gte_three_count_show.php");
    return response((string) $body, 200, ["Content-Type" => "application/json; charset=utf-8"]);
});

Route::get("/chrysalis-lte-two-count", function () {
    $body = require base_path("chrysalis/handlers/lte_two_count_show.php");
    return response((string) $body, 200, ["Content-Type" => "application/json; charset=utf-8"]);
});

Route::get("/chrysalis-eq-zero-count", function () {
    $body = require base_path("chrysalis/handlers/eq_zero_count_show.php");
    return response((string) $body, 200, ["Content-Type" => "application/json; charset=utf-8"]);
});
...
Route::get("/chrysalis-items-snapshot", function () {
    $body = require base_path("chrysalis/handlers/items_snapshot_show.php");
    return response((string) $body, 200, ["Content-Type" => "application/json; charset=utf-8"]);
});
...
Route::get("/chrysalis-socialite-fortify-probe", function () {
    $body = require base_path("chrysalis/handlers/chrysalis_socialite_fortify_probe_show.php");
    return response((string) $body, 200, ["Content-Type" => "application/json; charset=utf-8"]);
});
