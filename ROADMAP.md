...
- **Recently shipped:** **G2427–G2431** — queue **113** production search + CWL export depth. **G2417–G2421** queue **112**. Prior slices in [`ROADMAP-ARCHIVE.md`](./ROADMAP-ARCHIVE.md).
...
- **CWL / full-stack:** queues **111–113** active — **`docs/CWL-FULLSTACK-QUEUES-111-120.md`**; queue **114+** requires charter amendment.
