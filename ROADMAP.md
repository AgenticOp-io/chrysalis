...
- **Recently shipped:** **G3057–G3151** — queues **176–185** Phase F hub-bridge replay (schema **258**). **G2957–G3051** queues **166–175**. Prior slices in [`ROADMAP-ARCHIVE.md`](./ROADMAP-ARCHIVE.md).
...
- **CWL / full-stack:** queues **111–185 complete** (schema **258**); queue **186+** requires charter amendment.
