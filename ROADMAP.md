...
- **Recently shipped:** through **G2371** (self/static/foreach/float parser parity, B5.5 v12 bool/float cast inlining + 13-handler replay corpus). The full slice log lives in [`ROADMAP-ARCHIVE.md`](./ROADMAP-ARCHIVE.md).
