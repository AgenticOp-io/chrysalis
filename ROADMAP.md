...
- **Recently shipped:** through **G2380** (foreach/arrow/spaceship/pow parser parity, B5.5 v13 trim inlining + 14-handler replay corpus). The full slice log lives in [`ROADMAP-ARCHIVE.md`](./ROADMAP-ARCHIVE.md).
