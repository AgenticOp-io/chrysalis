...
- **Recently shipped:** **G2437–G2441** — queue **114** Fastify search emit + runtime hono parity. **G2427–G2431** queue **113**. Prior slices in [`ROADMAP-ARCHIVE.md`](./ROADMAP-ARCHIVE.md).
...
- **CWL / full-stack:** queues **111–114** active — **`docs/CWL-FULLSTACK-QUEUES-111-120.md`**; queue **115+** requires charter amendment.
