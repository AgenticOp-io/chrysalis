...
- **Recently shipped:** **G4357–G4551** — queues **306–325** Phase O post-234..253 replay (schema **398**). **G4157–G4351** queues **286–305**. Prior slices in [`ROADMAP-ARCHIVE.md`](./ROADMAP-ARCHIVE.md).
...
- **CWL / full-stack:** queues **111–325 complete** (schema **398**); queue **326+** requires charter in **`docs/CWL-FULLSTACK-QUEUES-321-330.md`**.
