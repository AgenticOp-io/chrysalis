...
- [x] **Retention / sizing (operator doc v0):** **`docs/ADMINISTRATION.md`** — **Corpus volume and retention (v0)** (rotation, compression, sizing heuristics); implementation backlog remains for automated rotation jobs.
