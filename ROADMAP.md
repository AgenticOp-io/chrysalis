...
- **Recently shipped:** **G2447–G2451** — queue **115** emit verify mega + session/diagnose. **G2437–G2441** queue **114**. Prior slices in [`ROADMAP-ARCHIVE.md`](./ROADMAP-ARCHIVE.md).
...
- **CWL / full-stack:** queues **111–115** active — **`docs/CWL-FULLSTACK-QUEUES-111-120.md`**; queue **116+** requires charter amendment.
