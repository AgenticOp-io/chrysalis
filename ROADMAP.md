...
- **Recently shipped:** **G3557–G3751** — queues **226–245** Phase K post-154..173 replay (schema **318**). **G3457–G3551** queues **216–225**. Prior slices in [`ROADMAP-ARCHIVE.md`](./ROADMAP-ARCHIVE.md).
